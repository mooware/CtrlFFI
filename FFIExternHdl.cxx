...
FFIValue *FFIValue::allocateValue(int type)
{
  switch (type)
  {
    ...
    // special types
    case CTRLFFI_RAW_POINTER: return new FFIPointerValue();
...
static const char * const TYPE_NAMES[CTRLFFI_MAX_VALUE] = {
  ...
  "FFI_RAW_POINTER", // CTRLFFI_RAW_POINTER
...
ffi_type *FFIExternHdl::getFFIType(int type)
{
  ...
  switch (type)
  {
    ...
    case CTRLFFI_RAW_POINTER: return &ffi_type_pointer;
